...
export function DecimalFieldConfig({ field, onChange, onRemove, showHeader = true }: FieldConfigProps) {
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base">{field.name || tFieldTypes('decimalFieldFallback')}</CardTitle>
          <Button
            variant="ghost"
            size="sm"
            onClick={onRemove}
