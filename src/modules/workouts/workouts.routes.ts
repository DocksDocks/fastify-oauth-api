            ...
            exercises: {
              ...
              items: {
                ...
                properties: {
                  ...
                  warmupRestSeconds: { type: ['integer', 'null'], minimum: 0, maximum: 3600 },
                  prepSetsCount: { type: 'integer', minimum: 0, maximum: 10 },
                  prepRestSeconds: { type: ['integer', 'null'], minimum: 0, maximum: 3600 },
                  workingSetsCount: { type: 'integer', minimum: 0, maximum: 10 },
                  workingRestSeconds: { type: ['integer', 'null'], minimum: 0, maximum: 3600 },
                },
              },
            },
          },
